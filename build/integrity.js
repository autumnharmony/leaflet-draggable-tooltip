...
const integritySrc = ssri.fromData(fs.readFileSync('dist/leaflet-draggable-tooltip-src.js'));
const integrityUglified = ssri.fromData(fs.readFileSync('dist/leaflet-draggable-tooltip.js'));
//const integrityCss = ssri.fromData(fs.readFileSync('dist/leaflet.css'));


console.log('Integrity hashes for ', version, ':');
console.log('dist/leaflet-draggable-tooltip-src.js: ', integritySrc.toString());
console.log('dist/leaflet-draggable-tooltip.js:', integrityUglified.toString());
